        ...
        <div class="layui-col-md4 form-center" >
            <form class="layui-form" action="<%=request.getContextPath()%>/dologin.html" method="post">
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label">账号登录</label>
                    <div class="layui-input-block">
                        <select id="processState" name="role" lay-verify="required">
...
<script>
    layui.use('form', function(){
        var form = layui.form;
        $.trim($("#processState").val());  //获取val
        $("#processState option:selected").text();//获取文本
        //各种基于事件的操作，下面会有进一步介绍
    });
</script>
</body>
