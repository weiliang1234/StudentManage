...
<script>
    layui.use(['table', 'form'], function () {
        ...
        table.render({
            ...
            , height: 523
            , url: '/sys/score.html?act=table' //数据接口
            , page: true //开启分页
            , cols: [[ //表头
                {type: 'checkbox', fixed: 'left'}
                , {field: 'coursenumber', title: '课程号'}
                , {field: 'coursename', title: '课程名称'}
                , {field: 'credit', title: '取得学分'}
        ...
        function openrolelayer(id) {//打开后往表单里添加数据
            layer.open({
                ...
                , btn2: function (index, layero) {
                    ...
                    $.ajax({
                        url: "sys/score.html?act=roleIds",
                        data:"userId="+id,
                        success:function (res) {
                            $('#menu-tree').tree({//打开成功后加载树
                                url: "sys/score.html?act=roleTree",//数据接口
                                checkbox: true,
