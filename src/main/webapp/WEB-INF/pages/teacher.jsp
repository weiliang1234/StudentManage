...
<script>
    layui.use(['table', 'form'], function () {
        ...
        table.render({
            ...
            , height: 523
            , url: '/sys/teacher.html?act=table' //数据接口
            , page: true //开启分页
            , cols: [[ //表头
                ...
                , {field: 'dateString', title: '入校日期',width: 150}
                ...
                case 'delete':
                    ...
                    layer.confirm('你确定要删除吗？', {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ids.push(data[i].jobnumber)
                        }
                        $.ajax({
                            url: "/sys/teacher.html?act=delete",
                            method: "post",
                ...
                case 'del':
                    layer.confirm('你确定要删除吗？', {
                        ...
                        $.ajax({
                            url: "/sys/teacher.html?act=delete",
                            method: "post",
                            data: "ids="+data.jobnumber,//获取当前行的id
                            success: function (res) {
                                if (res.status) {
                                    table.reload('userTable', {});//删除数据后刷新table
                                } else {
            ...
            layer.open({
                ...
                , yes: function (index, layero) {
                    ...
                    for (var i = 0; i < nodes.length; i++) {
                        roleIds.push(nodes[i].jobnumber)
                        console.log(nodes[i].jobnumber)
                    }

                    $.ajax({
                        url: "/sys/teacher.html?act=assign",
                        method: "post",
                        data: "jobnumber="+jobnumber+"&roleIds="+roleIds,
                        success: function (res) {
                            if (res.status) {
                                layer.close(index);
                            } else {
                ...
                , btn2: function (index, layero) {
                    ...
                    $.ajax({
                        url: "sys/teacher.html?act=roleIds",
                        data:"userId="+id,
                        success:function (res) {
                            $('#menu-tree').tree({//打开成功后加载树
                                url: "sys/teacher.html?act=roleTree",//数据接口
                                checkbox: true,
    ...
    <form class="layui-form" style="width:80%;padding-top: 20px" id="editForm" lay-filter="editForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="jobnumber" required lay-verify="required" placeholder="请输入工号" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">院系：</label>
            <div class="layui-input-block">
                <input type="text" name="department" required lay-verify="required" placeholder="请输入院系" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="position" required lay-verify="required" placeholder="请输入职位" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="education" required lay-verify="required" placeholder="请输入学历" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="nativeplace" required lay-verify="required" placeholder="请输入籍贯" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="dateString" required lay-verify="required" placeholder="请输入校日期" value="2020-10-6" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="phone" required lay-verify="required" placeholder="请输入联系方式" value="18766666666" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <%--<div class="layui-form-item">
